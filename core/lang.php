...
define('LANG_NEW_TICKET_REPLY_INFO', 'You can define the message that will be seen every time a new ticket is opened.');
...
define('LANG_NEW_MSG_REPLY_INFO', 'You can define the message that will be seen every time a reply is made to a ticket.');
...
define('LANG_CAT_TRANS_NOTICE_INFO', 'This message will be seen when a message has been transferred to a different category.');
...
define('LANG_ATTACH_DIR_TIP', 'This directory MUST exist and MUST be writeable (chmod 777) before you can enable attachments. (Note: must have a trailing slash)');
...
define('LANG_UP_ERR_WRITEPATH', 'Upload path is NOT writeable');
