...
class Securimage {
     ...
     * @var string
     */
    var $charset = 'abcdefghklmnorstuvwyz23456789';
     ...
     */
    function saveData() {
        $_SESSION['captcha_hash'] = md5(strtolower($this->code));
    }
    /**
     ...
     */
    function validate() {
        if (isset($_SESSION['captcha_hash']) && !empty($_SESSION['captcha_hash'])) {
            if ($_SESSION['captcha_hash'] == md5(strtolower(trim($this->code_entered)))) {
